(function (wp) {
    ...
    wp.blocks.registerBlockType('bookly/staff-cabinet-schedule', {
        title: BooklyStaffCabinetL10n.blocks.schedule.title,
        description: BooklyStaffCabinetL10n.blocks.schedule.description,
        icon: el('svg', { width: '20', height: '20', viewBox: "0 0 64 64" },
            ...
            el('path', {style: {fill: "rgb(217, 204, 189)", stroke: 'rgb(0, 0, 0)'}, d: "M 46.423 35.343 L 59.309 44.705 L 54.387 59.853 L 38.459 59.853 L 33.537 44.705 Z"}),
        ),
