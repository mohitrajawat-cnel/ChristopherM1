        ...
        <div class="card-body">
            <div class="card bookly-collapse-with-arrow">
                ...
                <div id='bookly_om_zoom' class='bookly-collapse bookly-show'>
                    <div class="card-body">
                        <?php Selects::renderSingle( 'bookly_zoom_authentication', __( 'Authentication', 'bookly' ), __( 'Select the type of authorization that will be used by default for staff members' ), array( array( Lib\Zoom\Authentication::TYPE_OAuth, 'OAuth 2.0' ), array( Lib\Zoom\Authentication::TYPE_JWT, 'JSON Web Tokens (JWT) - will be deprecated June 1, 2023' ) ) ) ?>
