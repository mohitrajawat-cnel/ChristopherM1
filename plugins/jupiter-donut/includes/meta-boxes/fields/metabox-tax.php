...
require_once( JUPITER_DONUT_INCLUDES_DIR . '/helpers/Tax-meta-class/Tax-meta-class.php' );
...
if ( is_admin() ) {
	...
	*/
	...
	$taxonomy_meta->addImage(
		$prefix . 'image_field_id',array(
			'name' => __( 'Thumbnail','jupiter-donut' ),
		)
	);
