  ...
  <div id="imagebox-item-<?php echo $id; ?>" class="mk-imagebox-item <?php echo  $el_class.' '.$icon_type . '-type'; ?>">
    <div class="item-holder">
      <div class="item-wrapper">
          ...
          echo mk_get_shortcode_view('mk_imagebox_item', 'components/image', true, ['image_padding' => $image_padding, 'icon_type' => $icon_type, 'item_image' => mk_get_wpml_media( $item_image ), 'item_title' => $item_title]);
