...
switch ($align) {
    case 'right':
        $class[] = 'jupiter-donutalign-right';
        break;

    case 'center':
        $class[] = 'jupiter-donut-align-center';
        break;

    case 'left':
        $class[] = 'jupiter-donut-align-left';
        break;
...
<div id="social-networks-<?php echo $id; ?>" class="mk-social-network-shortcode jupiter-donut-padding-0 jupiter-donut-margin-10-0 s_social jupiter-donut-list-reset <?php echo implode(' ', $class); ?> s_<?php echo $style; ?> social-align-<?php echo $align; ?> <?php echo $size; ?> <?php echo $el_class . ' jupiter-donut-' . $visibility; ?>">
	<ul class="jupiter-donut-margin-0 jupiter-donut-padding-0 a_list-style-none">
		<?php
			foreach ($sites as $name => $link) {
			    ...
			    echo !empty($link) ? '<li><a rel="noreferrer noopener" target="_blank" class="' . $name . '-hover c_" href="' . $link . '">'.Mk_SVG_Icons::get_svg_icon_by_class_name(false, $icon_name, $icon_size).'</a></li>' : '';
			}
		?>
	</ul>
</div>
