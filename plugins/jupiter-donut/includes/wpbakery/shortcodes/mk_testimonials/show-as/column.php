...
<div class="mk-testimonial js-el <?php echo $view_params['style']; ?>-style testimonial-column <?php echo $view_params['skin'].'-version '.$view_params['el_class']; ?> <?php echo $view_params['animation_css']; ?> jupiter-donut-clearfix" id="testimonial_<?php echo $view_params['id']; ?>" data-mk-component="Grid" data-grid-config='{"container":"#testimonial_<?php echo $view_params['id']; ?>", "item":".testimonial-item"}' >
