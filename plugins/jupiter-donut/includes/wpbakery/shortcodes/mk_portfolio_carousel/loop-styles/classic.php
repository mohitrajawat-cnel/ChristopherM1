<li>
	<div class="item-thumb">
		...
		<a class="hover-icon item-lightbox mk-lightbox" alt="<?php the_title_attribute(); ?>" data-fancybox="carousel-<?php echo $view_params['id']; ?>" title="<?php the_title_attribute(); ?>" href="<?php echo mk_get_portfolio_lightbox_url($view_params['post_type']); ?>">
