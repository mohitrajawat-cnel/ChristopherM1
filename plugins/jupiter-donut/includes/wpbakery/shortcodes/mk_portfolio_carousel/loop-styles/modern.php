		...
		<div class="featured-image">
		    ...
		    <?php if ($view_params['hover_scenarios'] != 'none') { ?>
			    ...
			    <div class="icons-holder">
			    	...
			    	<a class="hover-icon mk-lightbox" href="<?php echo mk_get_portfolio_lightbox_url($view_params['post_type']); ?>" title="<?php the_title_attribute(); ?>" data-fancybox="carousel-<?php echo $view_params['id']; ?>" >
