...
vc_map(array(
    ...
    "params" => array(
        ...
        [
            'type' => 'toggle',
            'heading' => __( 'Scroll on Click', 'jupiter-donut' ) ,
            'description' => __( 'Scroll to top of the accordion tab when the accordion is opened.', 'jupiter-donut') ,
            'param_name' => 'scroll_click',
            'value' => 'false',
            'dependency' => [
                'element' => 'responsive',
                'value' => 'false',
