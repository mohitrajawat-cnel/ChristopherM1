...
$json['places'][] = array(
	...
	"latitude"  => $latitude,
	"longitude" => $longitude,
	'marker'	=> mk_get_wpml_media( $custom_marker_1 )
);
...
if( !empty($latitude_2) && !empty($longitude_2) ) {
	$json['places'][] = array(
		...
		'marker'	=> mk_get_wpml_media( $custom_marker_2 )
	);
}
...
if( !empty($latitude_3) && !empty($longitude_3) ) {
	$json['places'][] = array(
		...
		'marker'	=> mk_get_wpml_media( $custom_marker_3 )
	);
}
...
$json['options']['apikey'] = jupiter_donut_get_option( 'google_maps_api_key' );
