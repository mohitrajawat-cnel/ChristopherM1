...
if( $btn_1_style == 'flat' ) {
	if( $btn_1_skin == 'light' ) {
		...
		$button1_bg_color = jupiter_donut_get_option( 'skin_color' );
		$button1_txt_color = 'light';
	}
}
...
if( $btn_2_style == 'flat' ) {
	if( $btn_2_skin == 'light' ) {
		...
		$button2_bg_color = jupiter_donut_get_option( 'skin_color' );
		$button2_txt_color = 'light';
	}
}
...
if( $btn_1_style == 'outline' ) {
	if( $btn_1_skin == 'light' ) {
		...
		$outline1_active_color = jupiter_donut_get_option( 'skin_color' );
		$outline1_hover_color = '#ffffff';
	}
}
...
if( $btn_2_style == 'outline' ) {
	if( $btn_2_skin == 'light' ) {
		...
		$outline2_active_color = jupiter_donut_get_option( 'skin_color' );
		$outline2_hover_color = '#ffffff';
	}
}
...
if($btn_2_style == 'flat'){
   ...
   if ($btn_2_skin == 'light') {
       ...
       $btn2_atts[] = 'outline_hover_color="'.$outline2_hover_color.'"';
   }
}
