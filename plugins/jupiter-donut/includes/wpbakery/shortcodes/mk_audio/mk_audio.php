...
$player->addClass( 'jupiter-donut-' . $visibility );
...
$mp3_file = mk_get_wpml_media( $mp3_file );
$ogg_file = mk_get_wpml_media( $ogg_file );
...
$player->find('.jp-loading')->append(Mk_SVG_Icons::get_svg_icon_by_class_name(false, 'mk-moon-spinner-12'));
