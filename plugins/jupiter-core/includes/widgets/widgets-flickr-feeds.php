...
?>
		...
		<p><label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e('Number of photo to show:', 'jupiter-core'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'column' ); ?>"><?php _e('Photos per each row:', 'jupiter-core'); ?></label>
