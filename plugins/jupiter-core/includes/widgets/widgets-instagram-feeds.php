	...
	function widget( $args, $instance ) {
		...
		if ( !empty( $instagram_id ) ) {
			...
			if(!is_numeric($instagram_id)) {
				echo '<p style="color:red">' . __('Your UserId must be digits, review your widget options and resolve the issues!', 'jupiter-core') . '</p>';
				return false;
			}
?>
...
?>
		...
		<label for="<?php echo $this->get_field_id( 'newtab' ); ?>"><?php _e( 'Open links in new tab?', 'jupiter-core' ); ?></label></p>
