...
?>
			...
			<?php if ( !empty( $phone ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-icon-phone', 16); ?><span><a itemprop="telephone" href="tel:<?php echo esc_attr( $phone ); ?>"><?php echo wp_kses_post( $phone ); ?></a></span></li><?php endif;?>
...
?>
		...
		<p><label for="<?php echo $this->get_field_id( 'person' ); ?>"><?php _e('Person:', 'jupiter-core'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'company' ); ?>"><?php _e('Company:', 'jupiter-core'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'address' ); ?>"><?php _e('Address:', 'jupiter-core'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'phone' ); ?>"><?php _e('Phone:', 'jupiter-core'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'fax' ); ?>"><?php _e('Fax:', 'jupiter-core'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'email' ); ?>"><?php _e('Email:', 'jupiter-core'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'website' ); ?>"><?php _e('Website:', 'jupiter-core'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'skype' ); ?>"><?php _e('Skype Username:', 'jupiter-core'); ?></label>
